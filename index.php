...
?>
    ...
    <main class="container">
        ...
        <div class="glass-card reveal" style="padding: 20px; text-align: center; border: 1px solid var(--accent-main); background: rgba(26,115,232,0.1);">
            <p style="font-weight: 700; text-transform: uppercase; letter-spacing: 2px;">
        ...
        <section id="licensing" class="glass-card reveal" style="padding: 60px; border-left: 4px solid var(--accent-main);">
            ...
            <h2 style="font-size: 2.5rem; margin-bottom: 20px;">Cinematic Catalog</h2>
            ...
            <div style="margin-top: 30px; display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
                <div style="padding: 20px; border: 1px solid rgba(255,255,255,0.1); border-radius: 12px;">
                    <p style="color: var(--accent-main); font-size: 0.7rem; font-weight: bold;">THRILLER</p>
                    <p><strong>Zero Sum</strong></p>
                </div>
                <div style="padding: 20px; border: 1px solid rgba(255,255,255,0.1); border-radius: 12px;">
                    <p style="color: var(--accent-main); font-size: 0.7rem; font-weight: bold;">NOIR</p>
        ...
        <section id="contact" class="glass-card reveal">
            <div class="contact-grid">
                <div>
                    <h2 style="font-size: 2.5rem; margin-bottom: 20px;">Get In Touch</h2>
                    <p style="color: var(--accent-main); font-weight: bold;">sync@doubleuofficial.online</p>
                </div>
                <form id="subscribe-form" action="process-contact.php" method="POST">
                    <input type="email" name="email" placeholder="Enter email address" style="width: 100%; padding: 15px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 10px; color: white; margin-bottom: 10px;" required>
